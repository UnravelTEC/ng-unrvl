...
export class HelperFunctionsService {
  ...
  */
  ...
  createHRTimeString(seconds) {
    ...
    const displayedDays = currentDays % 356;
    const textDays = displayedDays ? String(displayedDays) + ' d ' : '';

    const currentYears = Math.floor(currentDays / 356);
    const textYears = currentYears ? String(currentYears) + ' y ' : '';

    return (textYears + textDays + textHours + textMinutes + textSeconds + textMS).trim();
  }
  ...
  convVtoPPB(data: Array<any>, Praw_labels: Array<Object>, Pshort_labels: Array<string>, show_dev: boolean = false) {
    ...
    const calfactors = {
      ...
      '202180518': { // NO2-B43F ut-lcair
        ...
        'AE_zero': 0.220,
        'AE_elzero': 0.224,
        'zerodrift_y_ppb': [0, 10, 20], // 0 to 20  acc. to datasheet, take avg
        'sensitivity': 0.202, // mV / ppb
        'sensitivity_drift_p_y': [-0.2, -0.3, -0.4] // -20 to -40%  acc. to datasheet, take avg
      },
      ...
      '162830053': { // CO bfg-lcair
        ...
        'AE_zero': 0.319,
        'AE_elzero': 0.332,
        'zerodrift_y_ppb': [-100, 0, 100], // -100 to +100  acc. to datasheet, take avg
        'sensitivity': 0.493, // mV / ppb
        'sensitivity_drift_p_y': [0.1, 0.1, 0.1], // 10% acc. to datasheet
      },
      '160910951': { // NO bfg-lcair
        ...
        'AE_zero': 0.289,
        'AE_elzero': 0.276,
        'zerodrift_y_ppb': [0, 25, 50], // 0 to 50  acc. to datasheet, take avg
        'sensitivity': 0.645, // mV / ppb
        'sensitivity_drift_p_y': [0, -0.1, -0.2] // 0 to -20%  acc. to datasheet, take avg
      }
    }
