...
const appRoutes: Routes = [
  ...
  },
  {
    path: 'Apps/vif',
    loadChildren: () =>
      import('./ut-apps/vif/vif.module').then((m) => m.VifModule),
  },
  {
    path: 'Apps/IAQ',
    loadChildren: () =>
      import('./ut-apps/iaq/iaq.module').then((m) => m.IaqModule),
  },
  {
    path: 'Apps/Humidity',
    loadChildren: () =>
      import('./ut-apps/humidity/humidity.module').then(
        (m) => m.HumidityModule
      ),
  },
  {
    ...
    loadChildren: () =>
      import('./ut-apps/atmosphere/atmosphere.module').then(
        (m) => m.AtmosphereModule
      ),
  },
  {
    path: 'Apps/ADC',
    loadChildren: () =>
      import('./ut-apps/adc/adc.module').then((m) => m.AdcModule),
  },
  {
    path: 'Apps/ADC-Diff',
    loadChildren: () =>
      import('./ut-apps/adc-diff/adc-diff.module').then((m) => m.AdcDiffModule),
  },
  {
    path: 'Apps/CO2',
    loadChildren: () =>
  ...
  },
  {
    ...
    loadChildren: () =>
      import('./ut-apps/airq/airq.module').then((m) => m.AirqModule),
  },
  {
    path: 'Apps/CO2-graph',
    loadChildren: () =>
      import('./ut-apps/co2-graph/co2-graph.module').then(
        (m) => m.Co2GraphModule
      ),
  },
  {
    path: 'Apps/Ozone',
    loadChildren: () =>
      import('./ut-apps/ozone/ozone.module').then((m) => m.OzoneModule),
  },
  {
    path: 'Apps/rHT',
    loadChildren: () =>
      import('./ut-apps/r-ht/r-ht.module').then((m) => m.RHTModule),
  },
  {
    path: 'Apps/UV',
    loadChildren: () =>
      import('./ut-apps/uv/uv.module').then((m) => m.UvModule),
  },
  {
    path: 'Apps/PressureGraph',
    loadChildren: () =>
      import('./ut-apps/pressure-graph/pressure-graph.module').then(
        (m) => m.PressureGraphModule
      ),
  },
  {
    path: 'Apps/PM',
    loadChildren: () =>
      import('./ut-apps/pm/pm.module').then((m) => m.PmModule),
  },
  {
    path: 'Apps/PM-Analyzer',
    loadChildren: () =>
      import('./ut-apps/pm-analyzer/pm-analyzer.module').then(
        (m) => m.PmAnalyzerModule
      ),
  },
  {
    path: 'Apps/Flicker',
  ...
  },
  {
    path: 'Apps/voc',
    loadChildren: () =>
      import('./ut-apps/voc/voc.module').then((m) => m.VocModule),
  },
  {
    path: 'Apps/voc-raw',
    loadChildren: () =>
      import('./ut-apps/voc-raw/voc.module').then((m) => m.VocModule),
  },
  {
    path: 'Apps/loudness',
    loadChildren: () =>
      import('./ut-apps/loudness/loudness.module').then(
        (m) => m.LoudnessModule
      ),
  },
  {
    ...
    loadChildren: () =>
      import('./ut-apps/luminosity/luminosity.module').then(
        (m) => m.LuminosityModule
      ),
  },
  {
    path: 'Apps/noir',
  ...
  },
  {
    path: 'Apps/gamma',
    loadChildren: () =>
      import('./ut-apps/gamma/gamma.module').then((m) => m.GammaModule),
  },
  {
    path: 'Apps/Power',
    loadChildren: () =>
      import('./ut-apps/power/power.module').then((m) => m.PowerModule),
  },
  {
    path: 'Apps/Sensors',
    loadChildren: () =>
  ...
  },
  {
    ...
    loadChildren: () =>
      import('./ut-apps/sensors/sgp30/sgp30.module').then((m) => m.Sgp30Module),
  },
  {
...

  {
    ...
    loadChildren: () =>
      import('./ut-apps/sensors/type5/type5.module').then((m) => m.Type5Module),
  },
  {
    path: 'Apps/Sensors/MPU9250',
    loadChildren: () =>
      import('./ut-apps/sensors/mpu9250/mpu9250.module').then(
        (m) => m.Mpu9250Module
      ),
  },
  {
    ...
    loadChildren: () =>
      import('./ut-apps/sensors/mics6814/mics6814.module').then(
        (m) => m.Mics6814Module
      ),
  },
  {
    ...
    loadChildren: () =>
      import('./ut-apps/sensors/tgs5141/tgs5141.module').then(
        (m) => m.Tgs5141Module
      ),
  },
  {
    ...
    loadChildren: () =>
      import('./ut-apps/sensors/sgas/sgas.module').then((m) => m.SgasModule),
  },
  {
    path: 'Apps/Sensors/NO2-B43F',
    loadChildren: () =>
      import('./ut-apps/sensors/no2-b43f/no2-b43f.module').then(
        (m) => m.No2B43fModule
      ),
  },
  {
    ...
    loadChildren: () =>
      import(
        './ut-apps/sensors/galion-alphasense/galion-alphasense.module'
      ).then((m) => m.GalionAlphasenseModule),
  },
  {
    path: 'Apps/Sensors/TCS34725',
    loadChildren: () =>
      import('./ut-apps/sensors/tcs34725/tcs34725.module').then(
        (m) => m.Tcs34725Module
      ),
  },
  {
    ...
    loadChildren: () =>
      import('./ut-apps/temperatures/temperatures.module').then(
  ...
  },
  {
    ...
    loadChildren: () =>
      import('./ut-apps/dygraph-dev/dygraph-dev.module').then(
        (m) => m.DygraphDevModule
      ),
  },
  {
  ...
  },
  {
    path: 'Apps/Galion',
    loadChildren: () =>
      import('./ut-apps/galion/galion.module').then((m) => m.GalionModule),
  },
  {
    path: 'Apps/Galion-Vif',
    loadChildren: () =>
      import('./ut-apps/galion-vif/galion-vif.module').then(
        (m) => m.GalionVifModule
      ),
  },
  {
    path: 'Apps/IES',
    loadChildren: () =>
      import('./ut-apps/ies/ies.module').then((m) => m.IesModule),
  },
  {
  ...
  },
  {
    ...
    loadChildren: () =>
      import('./ut-apps/weihnachtsvorlesung/weihnachtsvorlesung.module').then(
        (m) => m.WeihnachtsvorlesungModule
      ),
  },
  {
