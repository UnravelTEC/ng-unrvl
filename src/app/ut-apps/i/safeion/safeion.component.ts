...
@Component({
  selector: 'app-safeion',
  templateUrl: './safeion.component.html',
  styleUrls: ['./safeion.component.scss'],
})
export class SafeionComponent implements OnInit {
  colors = [];
  graphWidth = 1500;
  setGraphWidth(width) {
  ...
  extraDyGraphConfig = {
    ...
    logscale: false,
    series: {
      'temperature sensor: MCP9600, type: K probe ( °C )': {
        axis: 'y2',
      },
    },
